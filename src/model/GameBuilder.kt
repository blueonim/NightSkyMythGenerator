...
fun createConstellations(): ConstellationOutput {
    ...
    wolf.connections = setOf(fish, mountain, tree, cat, basket)
    cat.connections = setOf(wolf, fish, mouse, basket, snake)
    mouse.connections = setOf(cat)
    fish.connections = setOf(mountain, wolf, cat, boat, fountain)
    boat.connections = setOf(friends, fish, anchor, fountain)
    anchor.connections = setOf(boat)
    friends.connections = setOf(mountain, boat, ladle, flower)
    mountain.connections = setOf(wolf, fish, friends, tree, eye)
    ...
    fountain.connections = setOf(fish, boat, dancer, snake, mask, teapot, coin)
    coin.connections = setOf(fountain)
    dancer.connections = setOf(fountain, ladle, teapot, chair)
    ladle.connections = setOf(friends, dancer, flower, chair, musician)
    ...
    teapot.connections = setOf(fountain, dancer, chair, mask, cup)
    cup.connections = setOf(teapot)
    chair.connections = setOf(ladle, dancer, musician, teapot)
